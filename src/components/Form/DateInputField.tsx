...
const DateInputField = ({label, value, onChange, name, min, max, required, children}: InputFieldProps & DateInputProps) => {
        ...
        <div className='flex flex-col flex-1'>
            ...
            <div onClick={() => dateRef.current?.focus()} 
                 ...
                 className='relative outline outline-2 outline-grey rounded-md py-4 px-2 mt-2 flex gap-2 items-center justify-center' >
                    ...
                    <input ref={dateRef} type="date" {...{value, onChange, name, min, max, required}} className='outline outline-transparent'/>
            </div>
        </div>
    )
}
